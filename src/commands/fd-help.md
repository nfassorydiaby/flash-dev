...
Cadrage (une fois par projet) :
  /fd-init → /fd-prd → /fd-stories → /fd-stories-review → /fd-architect → /fd-standards

Cycle par story :
  /fd-research <id> → /fd-plan <id> → /fd-execute <id> → /fd-test <id> →
  /fd-review <id> → /fd-security <id> → /fd-doc <id> → /fd-ship <id>
